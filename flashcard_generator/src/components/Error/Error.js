...
const Error404 = () => {
  return (
    <div className=" flex flex-col justify-center items-center dark:text-white">
      <h1
        className="xl:text-[250px] md:text-[160px] sm:text-[60px] text-[70px] font-bold text-transparent"
        style={{
      ...
      <h2 className="font-bold my-1 xl:text-4xl text-slate-700">
        404 - PAGE NOT FOUND
      </h2>
      <p className="xl:w-1/3 w-[80%] font-normal my-1 text-sm xl:text-base text-red-500 text-center">
